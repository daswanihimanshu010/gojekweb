class MainComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        socket.on('socketStatus', function (data) {
            console.log('You are connected to common room', data);
        });
        ...
        if( Object.keys(this.state.requests).length > 0 ) {
            if(this.state.account_status == "DOCUMENT" || this.state.account_status == "CARD" || this.state.account_status == "SERVICES" || this.state.account_status == "ONBOARDING") {
                ...
                if (status == "SEARCHING") {
                    ...
                    if(this.state.requests.service.admin_service_name == "TRANSPORT") {
                       window.location.replace("/provider/ride");
                    } else if(this.state.requests.service.admin_service_name  == "SERVICE") {
                        window.location.replace("/provider/service");
                    }else if(this.state.requests.service.admin_service_name  == "ORDER") {
...
class RequestComponent extends React.Component {
    ...
    handleAccept = e => {
        ...
        let service_id = this.props.request.service.id;
        ...
        $.ajax({
            ...
            success: (response, textStatus, jqXHR) => {
                ...
                var data = parseData(response);
                if(this.props.request.service.admin_service_name == "TRANSPORT") {
                    window.location.replace("/provider/ride");
                } else if(this.props.request.service.admin_service_name == "SERVICE") {
                    window.location.replace("/provider/service");
                }else if(this.props.request.service.admin_service_name == "ORDER") {
                    window.location.replace("/provider/order");
                }
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    render() {
        ...
        return (            
            ...
            {this.props.request.service.id == 3 ?
            <div>
            ...
            :'' }
            {this.props.request.service.id == 2 ?
            <div>
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0 d-flex">
            ...
            {this.props.request.service.id == 1 ?
