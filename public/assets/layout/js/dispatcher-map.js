...
function assignProviderShow(providers, request) {
    ...
    if(request.service.admin_service_name=="ORDER"){
    ...
    } else if(request.service.admin_service_name=="TRANSPORT"){
    ...
    providers.forEach(function(provider) {
        ...
        var content = "<p>Name : "+provider.first_name+" "+provider.last_name+"<br />"+
                ...
                "Service Type : "+request.service.admin_service_name+"<br />"+
                ...
                "<a href='javascript:;' data-id='"+request.request.id+"' data-service='"+provider.service.admin_service_id+"' data-city='"+request.city_id+"' data-provider='"+provider.id+"' class='btn btn-success assign_provider'>Assign this Provider</a>";
