    ...
    $.ajax({
        ...
        success: function(response, textStatus, jqXHR) {
            ...
            for (var i in Object.keys(data)) {
                ...
                if(Object.keys(data)[i]=='admin_service_id'){

                    var admin_service_id = Object.values(data)[i];
                }
                if(Object.keys(data)[i]=='menu_type_id'){
                    
                   loadServiceList('menu_type_id',data['service_list'],Object.values(data)[i], admin_service_id);
                }
