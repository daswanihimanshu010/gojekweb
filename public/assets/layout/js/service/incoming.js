                    ...
                    <form id="service_creation" encType="multipart/form-data">                 
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0 d-flex">
                            <div className="col-xs-12 col-sm-12 col-md-10 col-lg-11 p-0">
                                ...
                                {this.props.request.status == "ARRIVED" && getSiteSettings().service.serve_otp == 1 ?<input id="otp" className="form-control float-right numbers"  autoComplete="off" placeholder="Enter OTP" maxLength="4" type="text" name="otp"  />:""}
                                ...
                                <dl className="dl-horizontal left-right">
                                    ...
                                    <dd>$ {this.props.request.payment.payable}</dd>
                                </dl>
                                    </div>
                                </div> :""}
