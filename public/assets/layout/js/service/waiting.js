class MainComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        $.ajax({
            url: getBaseUrl() + "/user/service/check/request",
            type: "get",
            async: false,
            processData: false,
            contentType: false,
    ...
    render() {
        ...
        if (status === "SEARCHING") {
            ...
            if(this.state.requests.payment_mode == 'CARD'){
                                    ...
                                    <div className="col-md-12 col-lg-12 col-sm-12 p-0">
                                        <form>
                                            ...
                                            <div className="trip-user dis-ver-center col-lg-12 col-md-12 col-sm-12 mb-4">
                                                ...
                                                <div className="dis-column col-lg-6 col-md-6 col-sm-6 p-0">
                                                    { getSiteSettings().service.serve_otp==1 ? <span className="otp"> OTP : {this.props.request.otp} </span>:'' }
       ...
       // let admin_service_id = this.props.request.service_type.admin_service_id;
        ...
        $.ajax({
            ...
            success: (data, textStatus, jqXHR) => {
                ...
                window.location.replace("/user/service/"+service_id);
                $(".ride-section").removeClass('d-none');
