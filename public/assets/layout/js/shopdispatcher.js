                            ...
                            {requests.map((request) =>
                                <div key={request.id} onClick={ this.handleClick.bind(this, request) } className="bg-white m-lr-20 shadow-sm">
                                    ...
                                    <div className="p-2">
                                        ...
                                        <p className="font_14">Payment: {request.user.payment_mode}</p>
                                        <a className=" m-2 c-pointer btn btn-blue " href="javascript:;" onClick={ this.handleOrderlist.bind(this, request) } data-toggle="modal" data-target="#order-list">Order List</a>
                                        {request.store_order_dispute==null ?
                                            <span><a className=" m-2 c-pointer btn btn-green" href="javascript:;" onClick={ this.handleAccept.bind(this, request) } data-toggle="modal" data-target="#accept">Accept</a>
                                        <a className=" m-2 c-pointer btn btn-red" href="javascript:;" onClick={ this.handleCancel.bind(this, request) }>Cancel <i className="material-icons">cancel</i></a></span>
                                        :<span className=" m-2 c-pointer btn btn-green"  >Open Dispute</span> }
                                    </div>
                                </div>
                                )
                            }
                            ...
                            {requests.map((request) =>
                                <div key={request.id} onClick={ this.handleClick.bind(this, request) } className="bg-white m-lr-20 shadow-sm">
                                    ...
                                    <div className="p-2">
                                        ...
                                        <p className="font_14">Payment: {request.user.payment_mode}</p>
                                        <a className=" m-2 c-pointer btn btn-blue " href="javascript:;" onClick={ this.handleOrderlist.bind(this, request) } data-toggle="modal" data-target="#order-list">Order List</a>
                                        {(request.order_type == 'TAKEAWAY')? <a className=" m-2 c-pointer btn btn-red" href="javascript:;" onClick={ this.handletakeaway.bind(this, request) }>Take Away <i className="material-icons">check</i></a> : ""}
