        ...
        "columns": [
            ...
            { "data": function (data, type, row) {
                ...
                if({{Helper::getDemomode()}} != 1){
                    ...
                    <li><a href="javascript:;" data-id="`+data.id+`" data-value="`+data.status+`" class="dropdown-item status"><i class="fa fa-trash"></i>&nbsp;Status</a> </li> 
...
function getPrice(id) {
    ...
    function getData(vehicleId,cityId,countryId){
        ...
        $('#'+cityId).addClass(" active");
            ...
            var tax =0;
            var url = getBaseUrl() + "/admin/rideprice/ride_delivery_vehicle_id/city_id"
                url = url.replace('ride_delivery_vehicle_id', vehicleId);
                        ...
                        <div class="tab-content pricing-nav nav-wrapper" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="daily" role="tabpanel" aria-labelledby="nav-daily-tab">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Hour Price ($0.00)</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Base Price ($0.00)</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="feFirstName">Unit Time Pricing ($0.00)</label>
    ...
    $('body').on('click', '.addPrice', function(event) {
        event.preventDefault();
            ...
            success: function(response, textStatus, xhr) {
                alertMessage("Success", xhr.responseJSON.message, "success");
                $(".modal").modal("hide");
