...
@section('title') Overall Transport Statements @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">Overall Transport Statements</span>
            <h3 class="page-title">Overall Transport Statements</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Overall Transport Statements</h6>
                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="card dashboard_card">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <p class="card-category stats-small__label text-uppercase">Total No. of Rides</p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="card dashboard_card">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <p class="card-category stats-small__label text-uppercase">Cancelled Rides</p>
...
$(document).ready(function() {
    ...
    $('body').on('click', '.view', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/requestdetails/') }}/"+$(this).data('id')+"/view", function(data) {
    ...
    table = table.DataTable( {
        ...
        "ordering": false,
        "ajax": {
            "url": getBaseUrl() + "/admin/requestStatementhistory?country_id="+countryVal+"&type="+typeVal+"&from="+FromDate+"&to="+ToDate,
            "type": "GET",
