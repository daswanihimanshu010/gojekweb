                     ...
                     <div id="ride-book" class="col-sm-12 col-md-12 col-lg-5 p-0 form-section d-none">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 p-0 card-feild">
                           ...
                           <div class="field-box card" style="display:none">
                              <select class="custom-select" name="card_id">
                              </select>
                           </div>
                        </div>
                              ...
                              <ul class="estimation invoice"></ul>
                                 ...
                                 <div class="row">
                                    <div id="my_wallet" class="col-md-6 col-sm-12 col-xl-4 dis-end mt-2 d-sm-none d-md-none d-xl-block online">
                                          ...
                                          <label class="toggleSwitch nolabel" onclick="">
                                             ...
                                             id="use_wallet" type="checkbox" checked="" autocomplete="off">
                                             <span>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xl-4 dis-end mt-2 d-sm-none d-md-none d-xl-block online">
                                       <h5 class="p-0 go-online">@lang('transport.user.wheel_chair')</h5>
                                      
                                       <label class="toggleSwitch nolabel" onclick="">
                                          <input name="wheel_chair" value="1"
                                             id="filt1-1" type="checkbox" checked="" autocomplete="off">
                                          <span>
                                             <span class="show1">@lang('transport.user.no')</span>
                                             <span class="show2">@lang('transport.user.yes')</span>
                                          </span>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xl-4 dis-end mt-2 d-sm-none d-md-none d-xl-block online">
                                          ...
                                          <label class="toggleSwitch nolabel" onclick="">
                                             <input name="child_seat" value="1"
                                                id="filt1-3" type="checkbox" checked="" autocomplete="off">
                                             <span>
                                                <span class="show1">@lang('transport.user.no')</span>
                                                <span class="show2">@lang('transport.user.yes')</span>
                                             </span>
                                 ...
                                 <div class="row">
                                    <div  class="col-md-6 col-sm-12 col-xl-6 dis-end mt-2 d-sm-none d-md-none d-xl-block online">
                                          ...
                                          <label class="toggleSwitch nolabel" onclick="">
                                             <input name="someone" value="1"
                                             id="someone" type="checkbox"  autocomplete="off">
                                             <span>
                                                <span class="show1">@lang('transport.user.no')</span>
                                                <span class="show2">@lang('transport.user.yes')</span>
                                             </span>
...
$('#someone').on('change',function(){
   ...
   $(document).ready(function(){
               ...
               if((Object.keys(data.responseData)).length > 0) {
                  ...
                  if(result.fare.estimated_fare != "") {
                     estimationHtml += `<li>
                                          ...
                                          <span class="pricing "><span class="estimate_amount">`+result.fare.estimated_fare+`</span><span> `+result.currency+`</span></span>
                                       </li>`;
                  }
                  ...
                  if(result.fare.estimated_fare != "") {
                     estimationHtml += `<li>
                                    ...
                                    <span class="txt-yellow pull-right"><span class="total_amount">`+result.fare.estimated_fare+`</span><span> `+result.currency+`</span></span>
                                    <hr>
                                 </li>`;
                  }
                  ...
                  if(promocodes.length > 0) {
                     for(var i in promocodes) {
                        coupons_html += `<li class="coupon-box">
                           <img src="{{ asset('assets/layout/images/transport/svg/coupon-outline.svg') }}">
      ...
      $("#book-now, #schedule-later").click(function() {
         ...
         if($('#someone').is(':checked')){ 
            if($('#someone_email').val() == "") { 
               $('.error_someone_email').html(`Someone Email is Required`);
               return false;
            }else{
               $('.error_someone_email').html(``);
            } 
            if($('#someone_mobile').val() == "") { 
               $('.error_someone_mobile').html(`Someone Mobile is Required`);
               return false;
            }else{
               $('.error_someone_mobile').html(``);
            } 
         }
   ...
   setTimeout(function(){ getRideTypes(); }, 100);
                     ...
                     for(var i in services) {
                           ...
                           serviceList += `<div class="item" style="width: 130px; float:left;">
                                    <div class="dis-column service-type">
                                       <input type="radio" name="service_type" value="`+services[i].id+`" id="service-`+services[i].id+`" tabindex="0">
                                       <label for="service-`+services[i].id+`" class="dis-column">
                                          <div class="left-icon p-0">
                                             ...
                                             <h6 class="m-0">`+services[i].vehicle_name+`</h6>
                                          </div>
                                       </label>
                                    </div>
                                 </div>`;
