...
<div class="row mb-4 mt-20">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;">{{$action_text}} Shop</h6>
        </div>
        <div class="form_pad">
        <form class="validateForm" files="true"> 
             ...
             <div class="form-row">
                ...
                <div class="form-group">
                        ...
                        <div class="row @if($dky=='ALL') everyday "  @else  singleday " style="display:none" @endif " >
                            <div class="col-xs-4">
                                <div class="form-group}}">
                                    ...
                                    <input type="checkbox" class="chk form-control {{$dky}}" @if($dky=='ALL') checked @endif  name="day[{{$dky}}]" value="{{$dky}}" >
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control time-picker open_{{$dky}}" name="hours_opening[{{$dky}}]" value="00:00" required>
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" class="form-control time-picker close_{{$dky}}" name="hours_closing[{{$dky}}]" value="00:00" required>
                                        <span class="input-group-addon">
                                            <i class="fa fa-clock-o"></i>
                                        </span>
                                    </div>
                        ...
                        <button type="submit" class="btn btn-accent ">{{$action_text}} Shops</button>
...
$(document).ready(function()
{
   ...
   $('.clockpicker').clockpicker({
    ...
    $('#everyday').change(function() {
     ...
     function loadcity(city_data,slected){
        $.each(city_data,function(key,item){
            var selected="";
            if(selected==item.city.id){
               selected="selected";
            }
     ...
     function loadcuisines(cuisines_data,slected){
         $.each(cuisines_data,function(key,item){
             var selected="";
            $("#cuisine_id").append('<option value="'+item.id+'" '+selected+ ' >'+item.name+'</option>');
         });
         $('#cuisine_id').val(slected);
    }

    function loadzone(zone_data,slected){
