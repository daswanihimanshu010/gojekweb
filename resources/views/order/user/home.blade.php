         ...
         <div class="page-wrapper z-1 content-box">
            ...
            <section class="restaurants-page pt-5 pb-5">
               <div class="row bg-white p-3">
                  <div class="col-md-12 col-sm-12 col-xl-2 filtsrc">
            ...
            if((data.responseData).length != 0) { 
                ...
                $.each(store_list, function(i,val){
                  ...
                  var store ='<div class="col-sm-12 col-lg-4 col-md-6 col-xl-4 text-xs-center text-sm-left restaurant-list">';
                    ...
                    <a class="img-fluid" href="#"><img src="'+val.picture+'" alt="Food logo">\
                    <span class="post-rate"><i class="fa fa-star-o"></i> '+val.rating+'</span></a>\
                    </div>\
                    ...
                    store+='</ul>\
                    <a href="'+url+'/'+val.id+'" class="btn btn-primary">View Menu</a>\
                    </div></div></div>';
                   
                    $('#store_list').append(store);
                });
            }else{
                  $('#store_list').html('<h5>No Restaurants Available</h5>');
               }
        }
      });
   }
