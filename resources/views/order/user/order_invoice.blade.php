                  ...
                  <div class="row">
                     <div class="col-sm-12 col-md-12 col-xl-8 margin-b-30 checkout-section">
                        ...
                        <div class="form-register w-100">
                           <div class="steps clearfix" style="padding-left:0px;margin-left:0px;">
                              <ul role="tablist" style="padding-left:0px;">
                     ...
                     <form class="validateForm getrate" name="ratingForm">
                        ...
                        <div class="modal-body">
                           <div class="dis-column col-lg-12 col-md-12 col-sm-12 p-0 ">
                              <div class="trip-user dis-column w-100">
...
<script type="text/javascript">
   ...
   socket.on('socketStatus', function (data) {
      console.log(`room_${window.room}_R${id}_ORDER`);
   ...
   $.ajax({
         ...
         success: (data, textStatus, jqXHR) => {
            if((data.responseData).length != 0) { 
               ...
               var admin_service_id = order_list.admin_service_id;
               $("#orderUserid").val(user_id);
               $("#orderProviderid").val(provider_id);
               $("#orderid").val(id);
               $("#ServiceType").val(admin_service_id);
              ...
              ongoingInitialize(order_list);
               ...
               if(order_list.status=='ACCEPTED' ||  order_list.status=='STORECANCELLED' || order_list.status=='PROVIDEREJECTED' || order_list.status=='RECEIVED'){
                  $(".steps .zero").addClass("current");
                  $(".steps .first").addClass("current");
                  $('#message_container').hide();
               }
               if(order_list.status=='PROCESSING' || order_list.status=='STARTED' || order_list.status=='PICKEDUP' || order_list.status=='REACHED' ){
                  $(".steps .zero").addClass("current");
                  $(".steps .first").addClass("current");
