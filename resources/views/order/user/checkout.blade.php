      ...
      <div class="modal crud-modal" id="addressModal">
         <div class="modal-dialog min-50vw">
            <div class="modal-content password-change">
               ...
               <!-- Add Card body -->
               <div class="modal-body">
                  <form id="address-form" method="post" class="w-100 validateaddressForm" style= "color:red;">
                     <div class="col-lg-12 col-md-12 col-sm-12 card-section p-0 b-0">
                       ...
                       <div class="col-sm-12 col-lg-12 form-group">
                          <!--  <span class="fa fa-location-arrow" style=" position: absolute; left: 5%; top: 25%;color: #495057;font-size: 18px;margin-right:10px;"></span> -->
                           <input class="form-control search-loc-form" type="text" id="pac-input" style="padding-left:40px;" name="map_address" placeholder="Search for area, street name.." required>
                        ...
                        <div class="col-sm-12 card-form form-group">
                               <div class="col-sm-12 form-group p-0">
                                 <h5 class=""><strong>Flat No</strong></h5>
                                 <input name="flat_no" required class="form-control" id="flat_no" type="text">
                              </div>
                              <div class="col-sm-12 form-group p-0">
                                 <h5 class=""><strong>Street</strong></h5>
                                 <input name="street" required class="form-control" id="street" type="text">
                              </div>
                              <div class="col-sm-12 form-group p-0">
                                 <h5 class=""><strong>Type</strong></h5>
                     ...
                     <div class="modal-footer">
                        <button type="submit"  class="btn btn-primary  btn-block change-pswrd payment-method" >Save</button>
                     </div>
                  </form>
               </div>
               <!-- Add Card body -->
      ...
      if((data.responseData).length != 0) { 
         ...
         $.each(list_promocode, function(i,val){
          list_promocodes +='<li class="coupon-box" id="coupon'+val.id+'">\
                           <img src="/assets/foody/foody/coupon-outline.svg">\
...
function showAddons(item_id,spid){
        $.ajax({
        url: getBaseUrl() + "/user/store/show-addons/"+item_id,
        type:"GET",
        processData: false,
        contentType: false,
        secure: false,
         ...
         success: (data, textStatus, jqXHR) => {
              var mycard ='';
               if((data.responseData).length != 0) { 
                  ...
                  var card_list = data.responseData;
                  $.each(card_list,function(index,card){
                    mycard+='<option value="'+card.card_id+'">XXXXXXXXXXX'+card.last_four+'</option>';
                  })
               }else{
                  mycard+='<option value="">No Card Available</option>';
               }
               $('#card_id').html(mycard);
               hideLoader();
         },
...
function addcart(prod_id,cart_id,qty,action){
