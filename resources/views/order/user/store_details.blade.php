               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-sm-6 col-md-3 col-xl-3 ">
                        ...
                        <input class="form-control" style="margin:10px 0;" type="text" id="search" name="search" placeholder="Search for dishes.." required >
                     </div>
             ...
             <div class="modal-dialog">
                <div class="modal-content">
                   ...
                   <a data-id=""  class="btn btn-primary btn-block item-nofresh" ><span class=""></span>NO </a>
                      <a data-id="" class="btn btn-primary btn-block item-fresh-cart" ><span class=""></span>Yes, start afresh </a>
                   </div>
                </div>
             </div>
          </div>
...
<script>
                ...
                $.each(store_data.products,function(key,item){ 
                          ...
                          prod_list+=' <div class="col-sm-12 col-md-6 col-xl-4 text-xs-center text-sm-left restaurant-list">\
                              <div class=" bg-gray restaurant-entry food-item-wrap">\
                                 ...
                                 <li class="list-inline-item"><h5 class="price pull-left">'+currency+item.item_price+'</h5> </li>';
                                if(store_data.shopstatus=='OPEN'){
                                  if((item.itemcart).length>0){
                                    $.each(item.itemcart,function(k,cartval){ 
                                       prod_list+='<li class="list-inline-item quantity pull-right ">\
                                       <span class="add  bminus" data-cartid="'+cartval.id+'"  data-id="'+item.id+'"  value="-" id="moins" >-</span>\
                                       <input class="form-control text-center qty_prod_'+item.id+'" readonly type="input" size="25" value="'+cartval.quantity+'" id="count">\
                                       <span class="minus  bplus" data-cartid="'+cartval.id+'"  data-id="'+item.id+'"   value="+"  id="plus" >+</span>\
                                       </li>';
                                    });
    ...
    $('body').on('propertychange input', '.qty_prod', forceNumeric);
      ...
      $('body').on('click','.addons',function(e){
          ...
          addcart(prod_id,cart_id,qty,'addnew');
...
function removecart(cart_id){
  ...
  $('body').on('click','.item-fresh-cart',function(e){
      ...
      $('#p_'+item_id).data('spid',1);

      $('#p_'+item_id).trigger( "click" );
      $('#warnModal').modal('hide');
  });
