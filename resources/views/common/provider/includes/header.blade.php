				...
				<ul class="w-100 dis-flex-end m-0">
					...
					<li class="col-xl-4 col-md-6 col-sm-12 p-0">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item c-pointer referdetail" data-toggle="modal" data-target="#referModal"><i class="material-icons ">card_giftcard</i> Referrrals</a>
                     <a class="dropdown-item c-pointer notification" data-toggle="modal" data-target="#notification"><i class="material-icons ">card_giftcard</i> Notification</a>
                  ...
                  <div class="col-md-12 col-xl-12 col-xs-12 p-0 mb-4">
                     <div class=" top small-box green mb-2">
                        ...
                        <div class="sub-box dis-column">
                           <span class="font-12 txt-white">Referral Count: <strong><span class ="user_referal_count"></span></strong></span>
                           <span class="font-12 float-right txt-white">Referral Amount: <strong><span class ="user_referal_amount"></span></strong></span>
                        </div>
                     </div>
                  </div>
                  <div class="dis-column col-lg-12 col-md-12 col-sm-12 p-0 bor-bottom mb-4 pb-4">
                  <h5 class="text-center">Invite your friends And earn <span class ="currency"></span><span class ="referal_amount"></span> for every  <span class ="referal_count"></span> Users </h5>
