   ...
   <div class="logo-section dis-center">
      ...
      <div id="password-change" class="col-sm-12 col-md-12 col-lg-12 dis-column">
         ...
         <div class="h-100 col-sm-12 col-md-12 col-lg-12 dis-column">
            <main class="">
               <h5 class="text-center mb-3">@lang('auth.reset_your_password')Reset your password</h5>
               <form class=" validateForm" >
                  <div class="col-md-12 p-0 ">
                     <div id="toaster" class="toaster"></div>
                     @if(isset($urlparam['at']))
                        @if($urlparam['at']=='mobile')
                        <input id="mobile" required name="username" maxlength="15" class="intl-tel phone form-control mb-4" placeholder="@lang('auth.phone_number')"  type="text">
                        @else
                        <input id="email" name="username" class="form-control mb-4" placeholder="@lang('auth.email_address')" type="email" aria-required="true" required>
                        @endif
                     @endif
