...
<section class="z-1 content-box" id="profile-form"> 
         <div class="profile-section">
            <div class="dis-center col-md-12 p-0 dis-center">
               ...
               <li class="nav-item">
                     <a class="nav-link active tabs all  ALL" id="ALL" data-value="all" data-toggle="tab" href="#all" role="tab" data-toggle="tab">@lang('provider.general')</a>
                  </li>
            ...
            for (var i in response) {
                if (response[i].providerservices) {
                    html += `<li class="nav-item">
                     <a class="nav-link  tabs ` + response[i].admin_service_name + `" data-value="` + response[i].admin_service_name + `" data-toggle="tab" href="#` + response[i].admin_service_name + `" role="tab" data-toggle="tab">` + response[i].admin_service_name + `</a>
                  </li>`;
                }
            }
