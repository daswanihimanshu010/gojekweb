...
<div class="login-bg ">
         ...
         <div id="sign-up" class="sign-in-section dis-center">
            <div class="h-100 col-sm-12 col-md-12 col-lg-12 dis-column ">
               ...
               <input id="email" name="email" class="form-control mb-4" placeholder="@lang('auth.email_address')E-mail Address" type="email" aria-required="true" >
               ...
               <input id="password" name="password" class="form-control mb-4" value="" placeholder="@lang('auth.welcome_create_account')Password" type="password" >
               <input id="password_confirmation" name="password_confirmation" class="form-control mb-4" value="" placeholder="@lang('auth.welcome_create_account')Confirm Password" type="password" >
               ...
               <input id="referral_code" name="referral_code" class="form-control mb-4" placeholder="@lang('auth.welcome_create_account')Referral Code" type="text" >
               </div>
               ...
               <button type="submit" class="btn btn-block btn-green btn-md mb-2 account_kit"  style="display:none !important">@lang('auth.next')<i class="fa fa-arrow-circle-right ml-2" aria-hidden="true"></i></button>
               </form>
...
var googleUser = {};
  ...
  function loginCallback(response) {
    ...
    if (response.status === "PARTIALLY_AUTHENTICATED") {
      ...
      $.get("https://graph.accountkit.com/{{ Helper::getSettings()->site->facebook_app_version }}/access_token?grant_type=authorization_code&code="+code+"&access_token=AA|{{ Helper::getSettings()->site->facebook_app_id }}|{{ Helper::getSettings()->site->facebook_app_secret }}",{ code : code }, function(data) {
            //console.log(data);
            $.get("https://graph.accountkit.com/{{ Helper::getSettings()->site->facebook_app_version }}/me?access_token="+data.access_token, function(data) {
               //console.log(data);
         });
      });
