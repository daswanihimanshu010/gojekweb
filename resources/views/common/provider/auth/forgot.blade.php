         ...
         <div id="emailtab" class="tab-pane active col-sm-12 col-md-12 col-lg-12">
              ...
              <form class="validateForm dis-center" >
                  <div class="col-md-12 p-0 ">
                     ...
                     <input id="email" name="email" class="form-control mb-4" placeholder="@lang('auth.email_address')" type="email" aria-required="true" required>
                     ...
                     <a href="{{url('provider/login')}}" id="sign" class="txt-secondary sign-up-link"><i class="fa fa-arrow-circle-left mr-2" aria-hidden="true"></i>@lang('auth.back_to_login')</a>
                </div>
               </form> 
