      ...
      <section class="z-1 content-box" id="profile-form">
                        ...
                        <form class="w-100 validateForm" style= "color:red;">
                              ...
                              <div class="col-md-12 pro-form dis-ver-center p-0">
                                 ...
                                 <div class="col-md-6 col-sm-12"> 
                                    ...
                                    <select class="form-control" name="language" id="language" disabled="true">
         ...
         <!--Add card details !-->
               <div role="tabpanel" class="tab-pane col-sm-12 col-md-12 col-lg-12 p-0  min-46vh payment_method" id="payment_method">
                  ...
                  <h4><strong class="title-bor">@lang('provider.bank_details')Bank Details</strong></h4> <br>
...
<script >
   ...
   function loginCallback(response) {
      if (response.status === "PARTIALLY_AUTHENTICATED") {
         ...
         $.get("https://graph.accountkit.com/{{ Helper::getSettings()->site->facebook_app_version }}/access_token?grant_type=authorization_code&code=" + code + "&access_token=AA|{{ Helper::getSettings()->site->facebook_app_id }}|{{ Helper::getSettings()->site->facebook_app_secret }}", {
               code: code
         }, function(data) {
               //console.log(data);
