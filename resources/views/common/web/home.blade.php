        ...
        <div class="container">
            <div class="banner-section">
                ...
                <div class="banner-content col-12 col-lg-6 col-xl-5 z-index1 dis-column-left p-0 ">
                    ...
                    <!-- <a class="btn btn-secondary mt-3 bg-white txt-green" href="./login.html"> Buy Now - Gojek Clone App  <i class="fa fa-arrow-circle-right ml-2" aria-hidden="true"></i></a> -->
                </div>
            </div>
        </div>
    </section>
    <section id="about" class="services-list"> 
        <div class="container-fluid">
            <div class="heading dis-column col-12 col-lg-12">
                <hr>
                <h1 class="text-center"><span class="txt-green">ONE APP </span>FOR ALL YOUR NEEDS</h1>
                <p class="mt-4 col-sm-12 col-md-12 col-lg-12 p-0 text-center">
                    We are now developing an app like GoJek for entrepreneurs across the world. The GoJek clone app is
                    an
                    amalgam of a variety of on-demand services onto a single platform. AppDupe’s whitelabel solutions
                    are
                    highly customizable and integrated with a myriad of features to choose from. Our ready-made
                    solutions
                    help your startup to innovate and grow faster than your counterparts.
                </p>
                <!-- <a class="btn btn-secondary mt-3 col-md-5 col-lg-3" href="./login.html"> Buy Now - Gojek Clone <i class="fa fa-arrow-circle-right ml-2" aria-hidden="true"></i></a> -->
            </div>
                        ...
                        <ul class="nav nav-tabs " role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " data-toggle="tab" href="#payment_method" role="tab"
                                    data-toggle="tab"><img src="{{ asset('assets/layout/images/common/svg/tools.svg') }}">Other Services</a>
                            </li>
                        </ul>
                    </div>
    ...
    <section id="features">
        <div class="container-fluid">
            <div class="heading dis-column">
                <hr>
                <h1 class="text-center"><span class="txt-green">{{Helper::getSettings()->site->site_title}}</span> App Features</h1>
                <p class="mt-4 col-lg-10 col-md-12 p-0 text-center">
                    A Gojek clone, depending on what service is required by the user, has three options.
    ...
    <section id="demo">
        ...
        <div class="">
            <div class="row dis-center">
                <div class="heading dis-column">
                    <hr>
                    <h1 class="txt-white">Download <span class="txt-white">{{Helper::getSettings()->site->site_title}}</span> Today</h1>
