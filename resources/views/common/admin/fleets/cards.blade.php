...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">Cards</span>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">Cards</h6>
        ...
        <div class="modal-content" >
            ...
            <form id="payment-form"  class="w-100 validatepaymentForm">
                ...
                <div class="modal-footer">
                        <button type="submit"  class="btn btn-accent  btn-block change-pswrd payment-method" >Save</button>
                </div>
            </form>
