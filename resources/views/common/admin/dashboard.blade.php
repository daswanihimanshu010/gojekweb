        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-danger card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase">No. of Fleets</p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card dashboard_card">
                <div class="card-header card-header-info card-header-icon">
                    ...
                    <p class="card-category stats-small__label text-uppercase">No. of Shops</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
            <div class="card card-small h-100">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Overall Summary</h6>
                </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Wallet Summary</h6>
                </div>
