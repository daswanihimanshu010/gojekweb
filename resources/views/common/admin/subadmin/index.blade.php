            ...
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{$type}} Manager</h6>
                        ...
                        @if($type == "Account")
                            <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> Add New {{$type}} Manager</a>
                        @else
                            <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> Add New {{$type}}</a>
                        @endif
