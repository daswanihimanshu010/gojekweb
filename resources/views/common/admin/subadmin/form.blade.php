            ...
            <form class="validateForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="name" class="col-xs-2 col-form-label">{{$type}} {{ __('admin.full_name') }}</label>
    ...
    $.ajax({
     ...
     $('.validateForm').validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).find('textarea.blob').each(function(i) {
                data.append( `picture`, blobToFile(( $(form).find('textarea.blob').val() ).replace(/data:image\/png;base64,/g, ''), $(this).attr('name')+".png", "image/png") );
            });
            var url = getBaseUrl() + "/admin/subadmin"+id;
