            ...
            @if(count(Helper::getServiceList())> 1)
                    <div class="form-row">
                        ...
                        <label for="notify_type" class="col-xs-2 col-form-label">@lang('admin.menu.flow_type')</label>
                            <select name="admin_service_id" id = "service_id" class="form-control">
    ...
    $('#menu_type_id').on('change',function(){
     ...
     if($("input[name=id]").length){
        ...
        success: function(response, textStatus, jqXHR) {
            var data=response.responseData;
             $('#service_id').val(data.admin_service_id);
             ...
             $service_id=data.admin_service_id;
     ...
     $('.validateForm').validate({
		...
		messages: {
            ...
            admin_service_id:  { required: "Service is required." },
