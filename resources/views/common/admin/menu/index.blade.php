                ...
                <thead>
                    <tr>
                       ...
                       <!--  <th data-value="icon">{{ __('admin.menu.icon') }}</th>
                        ...
                        <th data-value="admin_service_id">{{ __('admin.menu.service') }}</th>
...
$(document).ready(function() {
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            //     }
            // },
            { "data": "admin_service_id" ,render: function (data, type, row) {
...
function menuSelectCities(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            var countryCityList ='';
            countryCityList +=  `<a class="list-group-item" href="#" onclick="getData(`+id+`,'ALL','ALL')"><span>All Countries</span></a>`;
                ...
                countryCityList +=  `<a class="list-group-item `+ countryActiveClass +`" href="#" onclick="getData(`+id+`,`+value.country.id+`,'`+value.country.country_name+`')" id="`+value.country.id+`"><span>`+value.country.country_name+`</span></a>`;
