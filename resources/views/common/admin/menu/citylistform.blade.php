...
$(document).ready(function()
{
    ...
    if("{{$service}}"=="TRANSPORT"){
     var url= getBaseUrl() + "/admin/gettransportcity?city_id="+id;
    }else if("{{$service}}"=="SERVICE"){
    var url= getBaseUrl() + "/admin/getservicecity?city_id="+id; 
    }else{
    var url= getBaseUrl() + "/admin/getordercity?city_id="+id;
    }
