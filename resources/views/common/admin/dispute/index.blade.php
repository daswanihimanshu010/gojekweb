            ...
            <div class="card card-small">
                <div class="card-header border-bottom">
                    ...
                    @permission('dispute-create')
                        ...
                        <a href="javascript:;" class="btn btn-primary pull-right add"><i class="fa fa-plus"></i> <strong >Add  Dispute Reason</strong></a>
                ...
                <thead>
                    <tr>
                            ...
                            <th data-value="dispute_status">@lang('admin.dispute.dispute_status')</th>
