            ...
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left" style="margin:10!important;">City</h6>
                     ...
                     <a href="javascript:;" class="btn btn-success pull-right add" style="margin:10!important;" ><i class="fa fa-plus"></i> Add New City</a>
                ...
                <thead>
                    <tr>
                           ...
                           <!--  <th data-value="admin_service_id">@lang('admin.city.admin_service')</th> -->
...
function myFunction( event ) {
    ...
    $.each( event.city_service, function( key, row ) {
        ...
        var url = getBaseUrl() + "/admin/comission/country_id/city_id/admin_service_id"
        url = url.replace('country_id', event.country_id);
        url = url.replace('city_id', event.city_id);
        url = url.replace('admin_service_id', row.admin_service_id);
        $.ajax({
            url: url,
            type: "GET",
            async : false,
            ...
            <div class="tab-pane fade`+active+` id="`+row.admin_service.display_name+`" role="tabpanel" aria-labelledby="nav-`+row.admin_service.display_name+`-tab">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" value="`+row.admin_service_id+`" name="admin_service_id">
