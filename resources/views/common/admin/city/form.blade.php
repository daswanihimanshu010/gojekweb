        ...
        <div class="form_pad">
            <form class="validateForm">
                ...
                <div class="form-row">
                    ...
                    <!-- <div class="form-group col-md-6">
                        <label for="admin_service_id" class="col-xs-2 col-form-label">{{ __('admin.city.admin_service') }}</label>
                        <select multiple="multiple" name="admin_service_id[]" id ="admin_service_id" class="form-control">
...
$(document).ready(function()
{
     ...
     $('.validateForm').validate({
		...
		rules: {
            ...
            admin_service_id: { required: true },
		...
		messages: {
            ...
            admin_service_id: { required: "Admin Service is required." },
