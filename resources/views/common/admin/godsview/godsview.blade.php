        ...
        $.ajax({
            ...
            success: function(response, textStatus, jqXHR) {
                ...
                for (i = 0; i < locations.length; i++) {
                    ...
                    } else if (providers[i].request.status == 'ARRIVED') {
                    ...
                    if (providers[i].is_assigned == '0') {
                      ...
                      if(status=='ALL' || status=='ACTIVE'){
                          if (providers[i].is_assigned == '0') {
                            ...
                            if (type == 'service') {
                              mainservices +=`<span class="font-weight-bold">`+providers[i].request.request.service.service_category.service_category_name+`</span>,`;
                            }
                            if (type == 'order') {
    ...
    function showinfoWindow(marker) {
          ...
          if(status=='ALL' || status=='ACTIVE'){
              mainservices+=`<a href="javascript:void(0)" data-sid="`+type+`"   data-id="`+provider.id+`" class=" vservice" ><i class="material-icons">remove_red_eye</i></a>`;
                ...
                if (type == 'service') {
                  mainservices +=`<span class="font-weight-bold">`+provider.request.request.service.service_category.service_category_name+`</span>,`;
                }
                if (type == 'order') {
