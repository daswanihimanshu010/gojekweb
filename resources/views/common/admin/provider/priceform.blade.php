...
<div class="card-header border-bottom">
            ...
            <h6 class="m-0"style="margin:10!important;">Approval</h6>
</div>
<div class="row p-3">
            ...
            <div class="col-xs-12">
                <nav class="services">
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-daily-tab" data-toggle="tab" href="#daily" role="tab" aria-controls="daily" aria-selected="true">Provider Vehicles</a>
                    </div>
                </nav>
                ...
                <nav class="nav_document">
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-daily-tab" data-toggle="tab" href="#daily" role="tab" aria-controls="daily" aria-selected="true">Provider Document</a>
                    </div>
                </nav>
         ...
         var servicenames='';
             if(providerdetails.providerservice.length > 0 ){
                $.each(providerdetails.providerservice,function(key,service){
                  services[service.admin_service.id]=service.admin_service.admin_service_name;

                 if(providerservice[service.admin_service.admin_service_name] != undefined){
                    providerservice[service.admin_service.admin_service_name].push(service);
                  }else{
                    providerservice[service.admin_service.admin_service_name]=[];  
                    providerservice[service.admin_service.admin_service_name].push(service);
                  }
