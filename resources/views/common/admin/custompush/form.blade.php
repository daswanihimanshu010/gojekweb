...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            @endif
            <h6 class="m-0"style="margin:10!important;">{{$action_text}} CustomPush</h6>
        </div>
        <div class="form_pad">
            <form class="validateForm" method="POST" role="form" id="create_push">
                ...
                <div class="form-row">
                     <div class="form-group row" id="for_users" style="display: none;">
						<label class="form-group col-md-3 col-form-label">User Conditions</label>
						<div class="col-xs-5">
						...
						<div class="form-group col-md-3" id="user_active" style="display: none;">
                ...
                <div class="form-row">
                    <div class="form-group row" id="for_providers" style="display: none;">
						<label class="form-group col-md-3 col-form-label">Driver Conditions</label>
						<div class="col-xs-5">
						...
						<div class="form-group col-md-3" id="provider_active" style="display: none;">
