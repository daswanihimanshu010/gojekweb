                       ...
                       <li class="col-xl-4 col-md-6 col-sm-12 p-0">
                          ...
                          <div class="dropdown-menu">
                           <a class="dropdown-item" href="{{ url('user/profile/general') }}"><i class="material-icons">account_box</i> Profile
                              ...
                              <a class="dropdown-item" href="{{ url('user/trips') }}"> <i class="material-icons">history</i> History </a>
                              ...
                              <a class="dropdown-item notify c-pointer notification" data-toggle="modal" data-target="#notification"><i class="material-icons ">notifications</i> Notification<!--  <span class="count">3</span> --></a>
