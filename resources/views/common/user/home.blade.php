         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <a  class="btn btn-primary btn-block service_id">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
               </div>
            </div>
         </div>
      </div>
...
<script>
   ...
   $(document).ready(function() {
      ...
      $('.service_id').on('click', function(){
         ...
         {
            window.location.replace("/user/service/"+service);
         }
         else{
      ...
      $.ajax({
         ...
         success: (response, textStatus, jqXHR) => {
            ...
            for(var i in result) {
                  ...
                  if(result[i].service.admin_service_name == 'TRANSPORT') {
                     url = "{{ url('/user/ride') }}";
                  }
                 
                  if(result[i].service.admin_service_name == 'ORDER') {
                  ...
                  if(result[i].service.admin_service_name == 'SERVICE') {
                     $('#rides').append(`<div class="service-list col-md-3 col-lg-2 col-sm-12 p-0">
                        <div class="service-item item-shadow" style="background-color:`+ result[i].bg_color +`">
                        <img alt="" class="img-responsive" src="`+ result[i].icon +`">
                        <div class="blog-hover"></div>
         ...
         success: (response, textStatus, jqXHR) => {
            ...
            if(result.length > 0) {
               ...
               for(var i in result) {
                  if(result[i].service.admin_service_name == "TRANSPORT") {
                     html += `<li>
                        <h6 class="txt-yellow"><strong>`+result[i].service.admin_service_name+`</strong></h6>
                        <div class="bg-lit-yellow text-left">
                              ...
                              <br />
                              <a class="btn btn-primary" href="{{ url('/user/ride') }}/`+result[i].request.ride_type_id+`">View</a>
                        </div>
                     </li>`;
                  }
                  ...
                  if(result[i].service.admin_service_name == "ORDER") {
                     html += `<li>
                    <h6 class="txt-red"><strong>`+result[i].service.admin_service_name+`</strong></h6>
                    <div class="bg-lit-red text-left">
                        <h5 class="txt-white">shop Name : `+result[i].request.store.store_name+`</h5>
                        ...
                        <br />
                        <a class="btn btn-red" href="{{URL::to('user/store/list')}}/`+result[i].request.store.storetype.id+`">View</a>
                    </div>
                </li>`;
                  }
                  ...
                  if(result[i].service.admin_service_name == "SERVICE") {
                     html += `<li>
                    <h6 class="txt-blue"><strong>`+result[i].service.admin_service_name+`</strong></h6>
                    <div class="bg-lit-blue text-left">
                        ...
                        <h5 class="txt-white">Status : `+result[i].request.status+`</h5>
                        <br />
                        <a class="btn btn-blue" href="{{URL::to('/user/service')}}/`+result[i].request.service_id+`">View</a>
                    </div>
                </li>`;
                  }
