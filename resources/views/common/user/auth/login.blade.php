            ...
            <div class="dis-center">
               ...
               <form class=" h-100 col-sm-12 col-md-12 col-lg-12 col-xl-12 dis-column validateSignForm">
                    ...
                    <!--  w-100 -->
                     ...
                     <button type="submit" class="btn btn-block btn-secondary btn-md mt-2 signup account_kit" style="display:none !important">@lang('auth.signup')<i class="fa fa-arrow-circle-right ml-2" aria-hidden="true"></i></button>
