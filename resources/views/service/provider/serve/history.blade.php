                        ...
                        <div class="header-section">
                           <div class="c-pointer dis-column" style="width:50%;">
                              ...
                              <div class="dis-center">
                                 <img class="beforeImage w-100 p-2" src="/assets/layout/images/common/svg/photo.svg" class="w-100 p-2" alt="add_document">
                              </div>
                           </div>
                           <div class="c-pointer dis-column" style="width:50%;">
                              <h5 class="text-left">After</h5>
                              <div class="dis-center">
                                 <img class="afterImage w-100 p-2" src="/assets/layout/images/common/svg/photo.svg" class="w-100 p-2" alt="add_document">
                              </div>
                           </div>
                        </div>
                           <div class="trip-user">
...
@parent
   ...
   //For Dispute Details
   $.ajax({
      url:  getBaseUrl() + "/provider/getdisputedetails",
      type: "GET",
      headers: {
  ...
  //For get the dispute name
   ...
   $('body').on('click', '.dispute', function(e) {
        ...
        provider_id = $(this).data('provider_id');
         $.ajax({
            type: "GET",
            url: getBaseUrl() + "/provider/history-dispute/service/"+dispute_id,
   ...
   $('.validateForm').validate({
		...
		submitHandler: function(form,e) {
            ...
            var url = getBaseUrl() + "/provider/history-dispute/service/"+dispute_id;
