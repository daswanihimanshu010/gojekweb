            ...
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="service_category_alias_name" name="service_category_alias_name" placeholder="{{ __('service.admin.categories.alias') }}" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
